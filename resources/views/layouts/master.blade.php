...
<head>
    ...
    <title>FREE BOOTSTRAP TEMPLATE INSIDE LARAVEL</title>
				...
				<div class="row">
					<div class="col-sm-3 col-sm-offset-4">
						<div class="contact-text">
							<h3>Contact</h3>
							<address>
								E-mail: piuswanjiru@gmail.com<br>
								Phone: +254 0721 886 636<br>
							</address>
						</div>
    ...
    <footer id="footer">
        <div class="container">
            <div class="text-center">
                <p> Copyright  &copy;2016<a target="_blank" href="http://shapebootstrap.net/"> Evento </a>Theme. All Rights Reserved. <br> Designed by <a target="_blank" href="http://piuswanjiru.herokuapp.com">PIUS WANJIRU</a></p>                
            </div>
        </div>
    </footer>
    <!--/#footer-->
